...
def load_data():
    ...
    graph_5_14 = torch.load(graphs_dir + "/graph_5_14.TemporalData.simple").to(device=device)
    graph_5_15 = torch.load(graphs_dir + "/graph_5_15.TemporalData.simple").to(device=device)

    return [graph_5_8, graph_5_9, graph_5_11, graph_5_14, graph_5_15]
...
if __name__ == "__main__":
    ...
    # Load data
    graph_5_8, graph_5_9, graph_5_11, graph_5_14, graph_5_15 = load_data()
    ...
    test(inference_data=graph_5_14,
         memory=memory,
         gnn=gnn,
         link_pred=link_pred,
         neighbor_loader=neighbor_loader,
