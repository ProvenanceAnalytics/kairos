...
def load_data():
    ...
    return [graph_4_3, graph_4_4, graph_4_5, graph_4_9, graph_4_10, graph_4_11, graph_4_12]
...
if __name__ == "__main__":
    ...
    # Load data
    graph_4_3, graph_4_4, graph_4_5, graph_4_9, graph_4_10, graph_4_11, graph_4_12 = load_data()
    ...
    test(inference_data=graph_4_9,
         memory=memory,
         gnn=gnn,
         link_pred=link_pred,
         neighbor_loader=neighbor_loader,
         nodeid2msg=nodeid2msg,
         path=artifact_dir + "graph_4_9")

    test(inference_data=graph_4_10,
         memory=memory,
         gnn=gnn,
         link_pred=link_pred,
         neighbor_loader=neighbor_loader,
