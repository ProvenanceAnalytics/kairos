...
def load_data():
    graph_5_8 = torch.load(graphs_dir + "/graph_5_8.TemporalData.simple").to(device=device)
    graph_5_9 = torch.load(graphs_dir + "/graph_5_9.TemporalData.simple").to(device=device)
    graph_5_11 = torch.load(graphs_dir + "/graph_5_11.TemporalData.simple").to(device=device)
    graph_5_12 = torch.load(graphs_dir + "/graph_5_12.TemporalData.simple").to(device=device)
    graph_5_15 = torch.load(graphs_dir + "/graph_5_15.TemporalData.simple").to(device=device)
    graph_5_16 = torch.load(graphs_dir + "/graph_5_16.TemporalData.simple").to(device=device)
    graph_5_17 = torch.load(graphs_dir + "/graph_5_17.TemporalData.simple").to(device=device)

    return [graph_5_8, graph_5_9, graph_5_11, graph_5_12, graph_5_15, graph_5_16, graph_5_17]
...
if __name__ == "__main__":
    ...
    # Load data
    graph_5_8, graph_5_9, graph_5_11, graph_5_12, graph_5_15, graph_5_16, graph_5_17 = load_data()
    ...
    test(inference_data=graph_5_15,
         memory=memory,
         gnn=gnn,
         link_pred=link_pred,
         neighbor_loader=neighbor_loader,
    ...
    test(inference_data=graph_5_16,
         memory=memory,
         gnn=gnn,
         link_pred=link_pred,
         neighbor_loader=neighbor_loader,
         nodeid2msg=nodeid2msg,
         path=artifact_dir + "graph_5_16")

    test(inference_data=graph_5_17,
         memory=memory,
         gnn=gnn,
         link_pred=link_pred,
         neighbor_loader=neighbor_loader,
