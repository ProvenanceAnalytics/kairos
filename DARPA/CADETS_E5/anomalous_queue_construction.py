...
def compute_IDF():
    ...
    file_list = []
    file_path = artifact_dir + "graph_5_8/"
    file_l = os.listdir(file_path)
    for i in file_l:
        file_list.append(file_path + i)

    file_path = artifact_dir + "graph_5_9/"
    file_l = os.listdir(file_path)
    for i in file_l:
        file_list.append(file_path + i)

    file_path = artifact_dir + "graph_5_11/"
    file_l = os.listdir(file_path)
    for i in file_l:
        file_list.append(file_path + i)

    file_path = artifact_dir + "graph_5_12/"
    file_l = os.listdir(file_path)
    for i in file_l:
        file_list.append(file_path + i)
...
if __name__ == "__main__":
    ...
    history_list = anomalous_queue_construction(
        node_IDF=node_IDF,
        tw_list=tw_list,
        graph_dir_path=f"{artifact_dir}/graph_5_12/"
    )
    torch.save(history_list, f"{artifact_dir}/graph_5_12_history_list")
    ...
    history_list = anomalous_queue_construction(
        node_IDF=node_IDF,
        tw_list=tw_list,
        graph_dir_path=f"{artifact_dir}/graph_5_16/"
    )
    torch.save(history_list, f"{artifact_dir}/graph_5_16_history_list")

    history_list = anomalous_queue_construction(
        node_IDF=node_IDF,
        tw_list=tw_list,
        graph_dir_path=f"{artifact_dir}/graph_5_17/"
    )
    torch.save(history_list, f"{artifact_dir}/graph_5_17_history_list")